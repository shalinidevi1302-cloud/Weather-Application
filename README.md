...
The API returns the latitude and longitude of the location.
These coordinates are used to request weather information.
The Open-Meteo Weather API provides the current weather data.
The application processes the received data.
The weather information is displayed through the Streamlit interface.
Workflow
User enters City
       ↓
